...
YoungsterData:
	...
	db 23,GOLBAT,NIDOKING,0
	db 17,SPEAROW,0
	db 36,SANDSHREW,0
	db 17,SANDSHREW,RATTATA,FARFETCHD,SPEAROW,0
	db 10,RATTATA,SPEAROW,PIDGEY,0
BugCatcherData:
	...
	db 18,VENONAT,PARAS,SCYTHER,0
	db 17,BEEDRILL,PINSIR,BUTTERFREE,SCYTHER,0
LassData:
	...
	db 17,GROWLITHE,TENTACOOL,EEVEE,VULPIX,0
SailorData:
...
PokemaniacData:
	...
	db 39,NIDOQUEEN,0
	db 38,KADABRA,SLOWBRO,ARCANINE,0
SuperNerdData:
...
HikerData:
	...
	db 41,RHYHORN,HAUNTER,MACHAMP,0
...
FisherData:
	...
	db 42,LAPRAS,0
	db 42,GOLEM,DRAGONAIR,STARMIE,DRAGONAIR,0
	...
	db 72,KABUTOPS,VAPOREON,BLASTOISE,WIGGLYTUFF,SLOWBRO,0
...
BirdKeeperData:
	...
	db 56,DUGTRIO,FARFETCHD,DODUO,PIDGEOT,0
...
Green1Data:
	db 5,EEVEE,0
	db $FF,10,GROWLITHE,10,SQUIRTLE,10,EEVEE,0
...
;JessieJamesData:
	db 19,EKANS,MEOWTH,KOFFING,WEEPINBELL,0
	db 48,MEOWTH,WEEZING,ARBOK,VICTREEBEL,0
	db 52,MEOWTH,ARBOK,WEEZING,VICTREEBEL,LICKITUNG,0
	db 68,LICKITUNG,ARBOK,MEOWTH,GYARADOS,VICTREEBEL,WEEZING,0
...
CooltrainerMData:
	...
	db 84,TAUROS,0
	db 86,RAICHU,VILEPLUME,PRIMEAPE,ARCANINE,BLASTOISE,HYPNO,0
CooltrainerFData:
	...
	db 43,PERSIAN,0
BrunoData:
	db $FF,94,PRIMEAPE,94,POLIWRATH,94,ONIX,94,HITMONLEE,94,HITMONCHAN,94,MACHAMP,0
BrockData:
...
BlaineData:
	db $FF,96,NINETALES,96,RAPIDASH,96,CHANSEY,96,CHARIZARD,96,ARCANINE,96,MOLTRES,0
SabrinaData:
	db $FF,72,HYPNO,72,ALAKAZAM,72,JYNX,72,EXEGGUTOR,72,MEW,72,MEWTWO,0
GentlemanData:
...
Green2Data:
	...
	db $FF,90,MEW,90,JOLTEON,90,LAPRAS,90,EXEGGUTOR,90,JYNX,90,MEWTWO,0
Green3Data:
	db $FF,100,MEW,100,JOLTEON,100,LAPRAS,100,EXEGGUTOR,100,JYNX,100,MEWTWO,0
	db $FF,100,MEW,100,JOLTEON,100,LAPRAS,100,EXEGGUTOR,100,JYNX,100,MEWTWO,0
	db $FF,100,MEW,100,JOLTEON,100,LAPRAS,100,EXEGGUTOR,100,JYNX,100,MEWTWO,0
LoreleiData:
	db $FF,92,DEWGONG,92,VAPOREON,92,NIDOQUEEN,92,JYNX,92,LAPRAS,92,ARTICUNO,0
ChannelerData:
	db 32,GOLBAT,0
	db 38,HAUNTER,0
	...
	db 69,LAPRAS,0
	db 69,HAUNTER,KADABRA,MR_MIME,0
AgathaData:
	db $FF,80,HYPNO,80,CHANSEY,80,ALAKAZAM,80,JYNX,80,NIDOKING,80,GENGAR,0
LanceData:
	db $FF,98,GYARADOS,98,CHARIZARD,98,GENGAR,98,AERODACTYL,98,DRAGONITE,98,TAUROS,0
