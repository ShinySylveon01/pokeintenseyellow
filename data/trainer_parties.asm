...
MistyData:
	db $FF,25,EEVEE,25,MEOWTH,25,RATTATA,26,CLEFABLE,26,WIGGLYTUFF,26,LICKITUNG,0
LtSurgeData:
...
BlaineData:
	db $FF,100,NINETALES,100,RAPIDASH,100,CHANSEY,100,CHARIZARD,100,ARCANINE,100,MOLTRES,0
SabrinaData:
...
LanceData:
	db $FF,100,GYARADOS,100,CHARIZARD,100,GENGAR,100,AERODACTYL,100,DRAGONITE,100,TAUROS,0
