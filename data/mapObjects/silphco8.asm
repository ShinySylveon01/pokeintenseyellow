SilphCo8Object:
	...
	object SPRITE_ROCKET, 15,  1, STAY, LEFT, 2, OPP_ROCKET, 35
	object SPRITE_OAK_AIDE, 11,  4, STAY, DOWN, 3, OPP_SCIENTIST, 9
	object SPRITE_ROCKET,  8,  5, STAY, DOWN, 4, OPP_ROCKET, 36
