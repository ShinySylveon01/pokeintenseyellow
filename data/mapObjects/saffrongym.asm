SaffronGymObject:
	...
	db 9 ; objects
	object SPRITE_SABRINA, 10,  6, STAY, DOWN, 1, OPP_SABRINA, 1
	object SPRITE_MEDIUM, 10, 1, STAY, DOWN, 2, OPP_CHANNELER, 22
	object SPRITE_BUG_CATCHER, 17, 1, STAY, DOWN, 3, OPP_PSYCHIC_TR, 1
	object SPRITE_MEDIUM,  3,  6, STAY, DOWN, 4, OPP_CHANNELER, 23
	object SPRITE_BUG_CATCHER, 17,  6, STAY, DOWN, 5, OPP_PSYCHIC_TR, 2
	object SPRITE_MEDIUM,  3, 12, STAY, DOWN, 6, OPP_CHANNELER, 24
