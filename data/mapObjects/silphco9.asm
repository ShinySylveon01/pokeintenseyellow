SilphCo9Object:
	...
	object SPRITE_ROCKET, 14,  3, STAY, UP, 2, OPP_ROCKET, 37
	object SPRITE_OAK_AIDE, 23, 14, STAY, DOWN, 3, OPP_SCIENTIST, 10
	object SPRITE_ROCKET, 16,  3, STAY, UP, 4, OPP_ROCKET, 38
