SilphCo5Object:
	...
	object SPRITE_ROCKET,  8, 15, STAY, RIGHT, 2, OPP_ROCKET, 28
	object SPRITE_OAK_AIDE, 25,  1, STAY, RIGHT, 3, OPP_SCIENTIST, 6
	object SPRITE_ROCKER, 26,  2, STAY, UP, 4, OPP_JUGGLER, 1
	object SPRITE_ROCKET, 28,  4, STAY, DOWN, 5, OPP_ROCKET, 29
	object SPRITE_BALL, 2, 13, STAY, NONE, 6, TM_09
	object SPRITE_BALL, 4, 6, STAY, NONE, 7, PROTEIN
	object SPRITE_BALL, 28, 11, STAY, NONE, 8, CARD_KEY
