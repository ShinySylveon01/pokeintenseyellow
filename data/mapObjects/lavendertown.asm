LavenderTownObject:
	...
	db 6 ; warps
	warp 15, 13, 0, LAVENDER_POKECENTER
	warp 14, 5, 0, POKEMONTOWER_1
	warp 11,  9, 0, LAVENDER_HOUSE_1
	warp  3,  5, 0, LAVENDER_MART
	warp 3, 13, 0, LAVENDER_HOUSE_2
	warp 7, 13, 0, NAME_RATERS_HOUSE

	db 6 ; signs
	sign 13, 11, 4 ; LavenderTownText4
	sign 9, 3, 5 ; LavenderTownText5
	sign  4,  5, 6 ; MartSignText
	sign 16, 13, 7 ; PokeCenterSignText
	sign  7,  9, 8 ; LavenderTownText8
	sign 17, 7, 9 ; LavenderTownText9

	db 3 ; objects
	object SPRITE_LITTLE_GIRL, 15, 9, WALK, 0, 1 ; person
	object SPRITE_BLACK_HAIR_BOY_1, 10, 13, STAY, NONE, 2 ; person
	object SPRITE_BLACK_HAIR_BOY_2, 8, 7, WALK, 2, 3 ; person

	; warp-to
	warp_to 15, 13, LAVENDER_TOWN_WIDTH ; LAVENDER_POKECENTER
	warp_to 14, 5, LAVENDER_TOWN_WIDTH ; POKEMON_TOWER_1F
	warp_to 11,  9, LAVENDER_TOWN_WIDTH ; MR_FUJIS_HOUSE
	warp_to  3,  5, LAVENDER_TOWN_WIDTH ; LAVENDER_MART
