SilphCo7Object:
	...
	object SPRITE_ROCKET, 21,  1, STAY, RIGHT, 5, OPP_ROCKET, 32
	object SPRITE_OAK_AIDE, 21, 14, STAY, DOWN, 6, OPP_SCIENTIST, 8
	object SPRITE_ROCKET, 23,  1, STAY, LEFT, 7, OPP_ROCKET, 33
	object SPRITE_ROCKET, 18,  1, STAY, DOWN, 8, OPP_ROCKET, 34
	object SPRITE_BLUE, 3, 7, STAY, UP, 9 ; person
	object SPRITE_BALL, 1, 9, STAY, NONE, 10, CALCIUM
	object SPRITE_BALL, 23, 11, STAY, NONE, 11, TM_03
