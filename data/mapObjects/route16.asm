Route16Object:
	...
	db 7 ; objects
	object SPRITE_BIKER, 19, 14, STAY, DOWN, 1, OPP_BIKER, 5
	object SPRITE_BIKER, 15, 16, STAY, UP, 2, OPP_CUE_BALL, 1
	object SPRITE_BIKER, 13, 14, STAY, DOWN, 3, OPP_CUE_BALL, 2
	object SPRITE_BIKER, 10, 16, STAY, UP, 4, OPP_BIKER, 6
	object SPRITE_BIKER,  5, 14, STAY, LEFT, 5, OPP_CUE_BALL, 3
	object SPRITE_BIKER,  1, 16, STAY, RIGHT, 6, OPP_BIKER, 7
