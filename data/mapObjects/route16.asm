Route16Object:
	...
	db 7 ; objects
	object SPRITE_BIKER, 21, 14, STAY, DOWN, 1, OPP_BIKER, 5
	object SPRITE_BIKER, 19, 16, STAY, UP, 2, OPP_CUE_BALL, 1
	object SPRITE_BIKER, 17, 14, STAY, DOWN, 3, OPP_CUE_BALL, 2
	object SPRITE_BIKER, 15, 16, STAY, UP, 4, OPP_BIKER, 6
	object SPRITE_BIKER, 13, 14, STAY, DOWN, 5, OPP_CUE_BALL, 3
	object SPRITE_BIKER, 11, 16, STAY, UP, 6, OPP_BIKER, 7
