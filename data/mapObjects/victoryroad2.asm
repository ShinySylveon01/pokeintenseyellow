VictoryRoad2Object:
	...
	db 13 ; objects
	object SPRITE_HIKER, 14, 10, STAY, LEFT, 1, OPP_BLACKBELT, 9
	object SPRITE_BLACK_HAIR_BOY_2, 23,  6, STAY, LEFT, 2, OPP_JUGGLER, 2
	object SPRITE_BLACK_HAIR_BOY_1, 19, 8, STAY, DOWN, 3, OPP_TAMER, 5
	object SPRITE_BLACK_HAIR_BOY_2, 21, 13, STAY, DOWN, 4, OPP_POKEMANIAC, 6
	object SPRITE_BLACK_HAIR_BOY_2, 29, 11, STAY, LEFT, 5, OPP_JUGGLER, 5
