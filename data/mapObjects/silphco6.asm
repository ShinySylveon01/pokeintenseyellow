SilphCo6Object:
	...
	object SPRITE_ROCKET, 13,  1, STAY, RIGHT, 6, OPP_ROCKET, 30
	object SPRITE_OAK_AIDE,  3,  2, STAY, DOWN, 7, OPP_SCIENTIST, 7
	object SPRITE_ROCKET, 15,  1, STAY, LEFT, 8, OPP_ROCKET, 31
