SilphCo2Object:
	...
	object SPRITE_OAK_AIDE,  9, 14, STAY, DOWN, 2, OPP_SCIENTIST, 2
	object SPRITE_OAK_AIDE, 25,  1, STAY, LEFT, 3, OPP_SCIENTIST, 3
	object SPRITE_ROCKET, 24,  3, STAY, UP, 4, OPP_ROCKET, 23
	object SPRITE_ROCKET,  9, 16, STAY, UP, 5, OPP_ROCKET, 24
