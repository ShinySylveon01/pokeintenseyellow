...
; Pewter
PewterCashierText::
	TX_MART POKE_BALL,SUPER_POTION,ESCAPE_ROPE,ANTIDOTE,BURN_HEAL,AWAKENING,PARLYZ_HEAL

; Cerulean
CeruleanCashierText::
	TX_MART GREAT_BALL,HYPER_POTION,REVIVE,SUPER_REPEL,PP_UP,BURN_HEAL,AWAKENING,PARLYZ_HEAL
...
VermilionCashierText::
	TX_MART GREAT_BALL,HYPER_POTION,REVIVE,ELIXER,PARLYZ_HEAL,SUPER_REPEL

; Lavender
LavenderCashierText::
	TX_MART GREAT_BALL,HYPER_POTION,REVIVE,ESCAPE_ROPE,SUPER_REPEL,ANTIDOTE,ELIXER,ICE_HEAL,PARLYZ_HEAL
