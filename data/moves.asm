...
MoveEnd:
	...
	move RAZOR_WIND,   FLINCH_SIDE_EFFECT1,         80, NORMAL,    75, 10
	...
	move FLY,          NO_ADDITIONAL_EFFECT,        70, FLYING,    95, 15
	...
	move SOLARBEAM,    NO_ADDITIONAL_EFFECT,       120, GRASS,    100, 10
	...
	move ROCK_THROW,   FLINCH_SIDE_EFFECT1,         50, ROCK,      65, 15
	...
	move SKY_ATTACK,   FLINCH_SIDE_EFFECT1,        140, FLYING,    90,  5
	...
	move CLOSE_COMBAT, DEFENSE_DOWN_SIDE_EFFECT,   120, FIGHTING, 100, 15
	...
	move TRI_ATTACK,   NO_ADDITIONAL_EFFECT,       100, NORMAL,   100, 10
	move SUPER_FANG,   SUPER_FANG_EFFECT,            1, NORMAL,    90, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,        70, NORMAL,   100, 20
	move SUBSTITUTE,   SUBSTITUTE_EFFECT,            0, NORMAL,   100, 100
	move STRUGGLE,     RECOIL_EFFECT,               50, NORMAL,   100, 10
	move OCTAZOOKA,    POISON_SIDE_EFFECT2,         65, WATER,    100, 20
	move SLUDGE_BOMB,  POISON_SIDE_EFFECT2,        100, POISON,   100, 20
	move VOLT_TACKLE,  RECOIL_EFFECT,              100, ELECTRIC, 100, 15
	move SYNTHESIS,    HEAL_EFFECT,                  0, GRASS,    100, 30
	move SHADOW_BALL,  SPECIAL_DOWN_SIDE_EFFECT,    90, GHOST,    100, 15
	move FLAME_WHEEL,  BURN_SIDE_EFFECT1,           60, FIRE,     100, 15
	move DRAGONBREATH, PARALYZE_SIDE_EFFECT1,       60, DRAGON,   100, 10
	move FURY_CUTTER,  TWO_TO_FIVE_ATTACKS_EFFECT,  40, BUG,      100, 15
	move GIGA_DRAIN,   DRAIN_HP_EFFECT,             75, GRASS,    100, 10
	move SIGNAL_BEAM,  CONFUSION_SIDE_EFFECT,       75, BUG,      100, 15
	move AEROBLAST,    NO_ADDITIONAL_EFFECT,       150, FLYING,   100,  5
	move EXTREMESPEED, NO_ADDITIONAL_EFFECT,        80, NORMAL,   100, 10
	move ICICLE_SPEAR, TWO_TO_FIVE_ATTACKS_EFFECT,  15, ICE,      100, 20
	move POISON_FANG,  POISON_SIDE_EFFECT2,         85, POISON,   100, 15
	move ELECTRO_BALL, PARALYZE_SIDE_EFFECT1,       95, ELECTRIC, 100, 15
	move SCARY_FACE,   SPEED_DOWN2_EFFECT,           0, NORMAL,   100, 30
	...
	move DRAGON_PULSE, NO_ADDITIONAL_EFFECT,        85, DRAGON,   100, 15
	move MAGICAL_LEAF, SWIFT_EFFECT,                75, GRASS,    100, 20
	move SACRED_FIRE,  BURN_SIDE_EFFECT2,          100, FIRE,     100, 10
	move FREEZEBREATH, FREEZE_SIDE_EFFECT,         100, ICE,      100, 15
	move ZAP_CANNON,   PARALYZE_SIDE_EFFECT2,       95, ELECTRIC, 100, 10
	move FRENZY_PLANT, HYPER_BEAM_EFFECT,          150, GRASS,    100, 10
	move FAINT_ATTACK, SWIFT_EFFECT,                90, GHOST,    100, 15
	move HYPER_VOICE,  NO_ADDITIONAL_EFFECT,        90, NORMAL,   100, 15
	move HYDRO_CANNON, HYPER_BEAM_EFFECT,          150, WATER,    100, 10
	move BLAST_BURN,   HYPER_BEAM_EFFECT,          150, FIRE,     100, 10
